package scaler.user.security.service;
...
import scaler.user.security.modal.AuthorizationConsent;
import scaler.user.security.repository.AuthorizationConsentRepository;
